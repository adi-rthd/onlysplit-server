...
namespace OnlySplit.Infrastructure.Database.Migrations;

[DbContext(typeof(OnlySplitDbContext))]
[Migration("20260515120000_InitialCreate")]
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(name: "IX_activity_logs_CreatedAt", table: "activity_logs", column: "CreatedAt");
        migrationBuilder.CreateIndex(name: "IX_activity_logs_Type", table: "activity_logs", column: "Type");
        migrationBuilder.CreateIndex(name: "IX_activity_logs_UserId", table: "activity_logs", column: "UserId");
        migrationBuilder.CreateIndex(name: "IX_expense_splits_ExpenseId_UserId", table: "expense_splits", columns: new[] { "ExpenseId", "UserId" }, unique: true);
        migrationBuilder.CreateIndex(name: "IX_expense_splits_UserId", table: "expense_splits", column: "UserId");
        migrationBuilder.CreateIndex(name: "IX_expenses_CreatedAt", table: "expenses", column: "CreatedAt");
        migrationBuilder.CreateIndex(name: "IX_expenses_GroupId", table: "expenses", column: "GroupId");
        migrationBuilder.CreateIndex(name: "IX_expenses_PaidBy", table: "expenses", column: "PaidBy");
        migrationBuilder.CreateIndex(name: "IX_group_members_GroupId_UserId", table: "group_members", columns: new[] { "GroupId", "UserId" }, unique: true);
        migrationBuilder.CreateIndex(name: "IX_group_members_UserId", table: "group_members", column: "UserId");
        migrationBuilder.CreateIndex(name: "IX_groups_CreatedBy", table: "groups", column: "CreatedBy");
        migrationBuilder.CreateIndex(name: "IX_groups_InviteCode", table: "groups", column: "InviteCode", unique: true);
        migrationBuilder.CreateIndex(name: "IX_payments_RazorpayOrderId", table: "payments", column: "RazorpayOrderId", unique: true);
        migrationBuilder.CreateIndex(name: "IX_payments_RazorpayPaymentId", table: "payments", column: "RazorpayPaymentId");
        migrationBuilder.CreateIndex(name: "IX_payments_SettlementId", table: "payments", column: "SettlementId");
        ...
        migrationBuilder.CreateIndex(name: "IX_settlements_GroupId", table: "settlements", column: "GroupId");
        migrationBuilder.CreateIndex(name: "IX_settlements_PayerId_ReceiverId_Status", table: "settlements", columns: new[] { "PayerId", "ReceiverId", "Status" });
        migrationBuilder.CreateIndex(name: "IX_settlements_ReceiverId", table: "settlements", column: "ReceiverId");
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.DropTable(name: "expense_splits");
